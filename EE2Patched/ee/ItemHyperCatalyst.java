...
public class ItemHyperCatalyst extends ItemEECharged
{
      ...
      if (var5 == 0.0D)
      {
        for (int var10 = -2; var10 >= -((chargeLevel(var1) + 1) * (chargeLevel(var1) + 1)) - 1; var10--)
        {
          for (int var11 = -1; var11 <= 1; var11++)
          {
            ...
            {
              breakBlock(player, var1, var2, var7 + var11, var8 + var10, var9 + var12);
            }
          }
        }
      ...
      else if (var5 == 2.0D)
      {
        for (int var10 = 1; var10 <= (chargeLevel(var1) + 1) * (chargeLevel(var1) + 1); var10++)
        {
          for (int var11 = -1; var11 <= 1; var11++)
          {
            for (int var12 = -1; var12 <= 1; var12++)
            {
              breakBlock(player, var1, var2, var7 + var11, var8 + var12, var9 + var10);
            }
          }
        }
      ...
      else if (var5 == 3.0D)
      {
        for (int var10 = -1; var10 >= -((chargeLevel(var1) + 1) * (chargeLevel(var1) + 1)); var10--)
        {
          for (int var11 = -1; var11 <= 1; var11++)
          {
            for (int var12 = -1; var12 <= 1; var12++)
            {
              breakBlock(player, var1, var2, var7 + var10, var8 + var12, var9 + var11);
            }
          }
        }
    ...
    if (var7 == 0)
    {
      for (int var12 = 0; var12 < (chargeLevel(var1) + 1) * (chargeLevel(var1) + 1); var12++)
      {
        for (int var13 = -1; var13 <= 1; var13++)
        {
          ...
          {
            breakBlock(player, var1, var3, var9 + var13, var10 + var12, var11 + var14);
          }
        }
      }
    ...
    else if (var7 == 2)
    {
      for (int var12 = 0; var12 < (chargeLevel(var1) + 1) * (chargeLevel(var1) + 1); var12++)
      {
        for (int var13 = -1; var13 <= 1; var13++)
        {
          for (int var14 = -1; var14 <= 1; var14++)
          {
            breakBlock(player, var1, var3, var9 + var13, var10 + var14, var11 + var12);
          }
        }
      }
    ...
    else if (var7 == 4)
    {
      for (int var12 = 0; var12 < (chargeLevel(var1) + 1) * (chargeLevel(var1) + 1); var12++)
      {
        for (int var13 = -1; var13 <= 1; var13++)
        {
          for (int var14 = -1; var14 <= 1; var14++)
          {
            breakBlock(player, var1, var3, var9 + var12, var10 + var14, var11 + var13);
          }
        }
      }
  ...
  public void breakBlock(EntityHuman player, ItemStack var1, World var2, int var3, int var4, int var5)
  {
    int var6 = var2.getTypeId(var3, var4, var5);
    int var7 = var2.getData(var3, var4, var5);
	ItemStack			ks;
	
	ks = ItemToolHigh.getPlayerKleinStar(player);
	if (ks == null) {
		Bukkit.getServer().getPlayer(player.name).sendMessage("No Klein Star!");
		return;
	}
    ...
    if (Block.byId[var6] != null)
    {
      if ((var6 != 0) && (Block.byId[var6].getHardness(var7) >= 0.0F) && (Block.byId[var6].getHardness(var7) <= 10.0F))
      {
        ...
        if (!ItemToolHigh.useKleinCharge(ks, EEMaps.getEMC(var6, var7)))
			return;

		if (!BigWorldHook.setTypeIdHooked(var2, var3, var4, var5, 0))
			return;
