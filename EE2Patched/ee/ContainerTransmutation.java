...
public class ContainerTransmutation extends Container
{
  ...
  public ItemStack clickItem(int var1, int var2, boolean var3, EntityHuman var4)
  {
	...
	//if (var3) {
		// disable the dupe glitch the easy way..
		// yeah this is cheap but it WORKS...
		//return null;
	//}
	
	transGrid.onUpdate(var4.world, var4);

	//Bukkit.getServer().getLogger().info(String.format(
	//	"slotNdx:%d var2:%d var3:%d var4:%h",
	//	var1, var2, var3 == true ? 1 : 0, var4
	//));
