...
public class TileNovaCataclysm extends TileEE
{
  ...
  public void setDefaultDirection(int var1, int var2, int var3)
  {
    if (!this.world.isStatic)
    {
      ...
      if ((Block.n[var4] != false) && (Block.n[var5] == false))
      {
        var8 = 3;
      }

      if ((Block.n[var5] != false) && (Block.n[var4] == false))
      {
        var8 = 2;
      }

      if ((Block.n[var6] != false) && (Block.n[var7] == false))
      {
        var8 = 5;
      }

      if ((Block.n[var7] != false) && (Block.n[var6] == false))
      {
        var8 = 4;
      }
  ...
  public void lightFuse()
  {
    if (!this.fuseLit)
    {
	  if (BigWorldHook.novaPrimed > 10)
		return;
	  ++BigWorldHook.novaPrimed;
      this.fuseLit = true;
      BigWorldHook.setTypeIdHooked(this.world, this.x, this.y, this.z, 0);
  ...
  {
    return var1 == 1 ? EEBase.novaCatalystTop : var1 == 0 ? EEBase.novaCatalystBottom : EEBase.novaCataclysmSide;
  }
  ...
  public void onBlockDestroyedByExplosion() {
    ...
    {
      var1 = new EntityCataclysmPrimed(this.world, this.world.a(this.player), this.x + 0.5F, this.y + 0.5F, this.z + 0.5F);
    }
    else
    {
      var1 = new EntityCataclysmPrimed(this.world, this.x + 0.5F, this.y + 0.5F, this.z + 0.5F);
    }
