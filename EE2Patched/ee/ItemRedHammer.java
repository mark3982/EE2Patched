...
public class ItemRedHammer extends ItemToolHigh
{
  ...
  public boolean a(ItemStack var1, int var2, int var3, int var4, int var5, EntityLiving var6)
  {
    ...
    if ((var6 instanceof EntityHuman))
    {
      ...
      {
        doMegaImpact(var7, var7.world, var1, var3, var4, var5, EEBase.direction(var7));
      }
  ...
  public void doMegaImpact(EntityHuman player, World var1, ItemStack var2, int var3, int var4, int var5, double var6)
  {
    cleanDroplist(var2);
    ...
    for (int var8 = -1; var8 <= 1; var8++)
    {
      for (int var9 = -1; var9 <= 1; var9++)
      {
        ...
        if (!canBreak(var13, var14))
          continue;
        scanBlockAndBreak(player, var1, var2, var10, var11, var12);
      }
      ...
      for (int var9 = -(chargeLevel(var1) * (var7 == 4 ? 0 : var7 == 5 ? 2 : 1)); var9 <= chargeLevel(var1) * (var7 == 4 ? 2 : var7 == 5 ? 0 : 1); var9++)
      {
        for (int var10 = -(chargeLevel(var1) * (var7 == 0 ? 0 : var7 == 1 ? 2 : 1)); var10 <= chargeLevel(var1) * (var7 == 0 ? 2 : var7 == 1 ? 0 : 1); var10++)
        {
          for (int var11 = -(chargeLevel(var1) * (var7 == 2 ? 0 : var7 == 3 ? 2 : 1)); var11 <= chargeLevel(var1) * (var7 == 2 ? 2 : var7 == 3 ? 0 : 1); var11++)
          {
			...
			if (!breakBlock(null, var2, var3, var12, var13, var14, var15, var16))
				continue;
				
            ArrayList _var19 = Block.byId[var15].getBlockDropped(var3, var12, var13, var14, var16, 0);
            Iterator var18 = _var19.iterator();
