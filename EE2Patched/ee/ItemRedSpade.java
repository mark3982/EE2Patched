...
// will cause call stack overflow //@@mir:*:getDestroySpeed:*:ee/ItemToolLow:getDestroySpeed:*

public class ItemRedSpade extends ItemToolHigh
{
  ...
  public boolean interactWithSpecial(ItemStack var1, EntityHuman var2, World var3, int var4, int var5, int var6, int var7)
  {
    ...
    for (int var9 = -chargeLevel(var1); var9 <= chargeLevel(var1); var9++)
    {
      for (int var10 = -chargeLevel(var1); var10 <= chargeLevel(var1); var10++)
      {
		...
		if (!breakBlock(null, var2, var3, var11, var5, var13, var14, var15))
			continue;
  ...
  public void doBreakShovel(World var1, EntityHuman var2, ItemStack var3, int var4, int var5, int var6, int var7)
  {
	  ...
	  if (!breakBlock(null, var2, var1, var5, var6, var7, typeId, var8))
		return;
