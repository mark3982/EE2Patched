...
public class EEBase
{
  ...
  public static boolean EntityHasItemStack(ItemStack var0, IInventory var1)
  {
    ...
    for (var4 = 0; var4 < var1.getSize(); var4++)
    {
  ...
  public static boolean HasItemStack(ItemStack var0, EntityHuman var1)
  {
    ...
    for (var5 = 0; var5 < var4.items.length + var4.armor.length; var5++)
    {
  ...
  public static int getPlayerEffect(Item var0, EntityHuman var1)
  {
	...
	hm = (HashMap)playerEffectDurations.get(var1);
	if (hm == null) 
		return 0;
	if (hm.get(var0) == null)
		return 0;
	return ((Integer)hm.get(var0)).intValue();
	/*
    return 
		((HashMap)playerEffectDurations.get(var1)).get(var0) == null 
			? 0 
			: playerEffectDurations.get(var1) == null 
				? 0 
				: ((Integer)((HashMap)playerEffectDurations.get(var1)).get(var0)).intValue();
	*/
  }
  ...
  public static boolean getHammerMode(EntityHuman var0)
  {
    ...
    return ((Boolean)playerHammerMode.get(var0)).booleanValue();
  }
  ...
  public static void addPedestalCoords(TilePedestal var0)
  {
    int var1 = 0;
	Integer[] var2 = { 
		Integer.valueOf(var0.x), 
		Integer.valueOf(var0.y), 
		Integer.valueOf(var0.z)
	};
