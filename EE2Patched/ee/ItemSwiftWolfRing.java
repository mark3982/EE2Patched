...
public class ItemSwiftWolfRing extends ItemEECharged
{
  ...
  public void doActive(ItemStack var1, World var2, EntityHuman var3)
  {
	...
	//Bukkit.getServer().getLogger().info("active");
	
	//ks = ItemToolHigh.getPlayerKleinStar(var3);
	//if (ks == null) {
	//	var3.abilities.isFlying = false;
	//	Bukkit.getServer().getPlayer(var3.name).sendMessage("No Klein Star! (Flying Aint Free Bitch)");
	//	var3.move(0, -1.0, 0);
	//	return;
	//}
	...
	//if (!ItemToolHigh.useKleinCharge(ks, (8192 / 30 / 10) * 13)) {
	//	var3.abilities.isFlying = false;
		//Bukkit.getServer().getPlayer(var3.name).sendMessage("Klein does not have enough power!");
	//	var3.move(0, -1.0, 0);
	//	return;
	//}
  ...
  public void doToggle(ItemStack var1, World var2, EntityHuman var3) {
    ...
    //Bukkit.getServer().getLogger().info("toggle");

	ks = ItemToolHigh.getPlayerKleinStar(var3);
	if ((ks == null) && (var3.abilities.isFlying)) {
		var3.abilities.isFlying = false;
		var3.move(0, -1.0, 0);
		Bukkit.getServer().getPlayer(var3.name).sendMessage("No Klein Star! (Flying Aint Free Bitch)");
	}
