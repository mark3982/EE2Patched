...
public class ItemRedArmor extends ItemDarkArmor
{
  ...
  public ArmorProperties getProperties(EntityLiving var1, ItemStack var2, DamageSource var3, double var4, int var6) {
    //return (var6 != 0) && (var6 != 3) ? new ArmorProperties(0, 0.3D, 225) : (var6 == 0) && (var3 == DamageSource.FALL) ? new ArmorProperties(1, 1.0D, 10) : new ArmorProperties(0, 0.2D, 150);
    return new ArmorProperties(0, 0.5D, 200);
  }
